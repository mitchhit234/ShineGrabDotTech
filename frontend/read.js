const { getCharacterName } = require('@slippi/slippi-js/dist/melee/characters');
  ...
  app.post('/', function(req, res) {
    ...
    upload(req, res, function(err) {
      ...
      res.render('pages/start', {
          name: name,
          char1: getCharacterName(settings.players[0]['characterId']),
          char2: getCharacterName(settings.players[0]['characterId'])})
    })
  })
